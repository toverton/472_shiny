...
```{r}
week_inc <- ggplot(df, aes(x = day_of_week, y = total_incidents, fill = day_of_week)) +
  geom_col(show.legend = FALSE) + 
  labs(title = "Total Incidents by Day of the Week in the US (2013 - 2018)",
       x = "Day of the Week", y = "Total Incidents",caption = "Data: Gun Violence Data" ) +
